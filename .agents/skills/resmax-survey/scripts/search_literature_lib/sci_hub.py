"""Sci-Hub mirror fallback (Stage 5.5.a optional layer).
...
bypass publisher anti-bot walls (fragile). This option is disabled by default
and must be enabled explicitly by the caller.
